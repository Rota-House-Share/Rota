...
const { handleProofUpload } = require('../controllers/uploadController');
...
router.patch ('/:taskId/toggle',   handleProofUpload, toggleTaskStatus);
router.patch ('/:taskId/complete', handleProofUpload, toggleTaskStatus);
